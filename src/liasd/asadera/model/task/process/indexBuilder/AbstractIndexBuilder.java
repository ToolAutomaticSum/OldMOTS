...
public abstract class AbstractIndexBuilder<T extends WordIndex> extends ParametrizedMethod implements IndexBasedOut<T>, ListSentenceBasedOut {
	...
	public AbstractIndexBuilder(int id) throws SupportADNException {
		...
		listParameterOut.add(new ParametrizedType(SentenceModel.class, List.class, ListSentenceBasedOut.class));
	}
	...
	public boolean isOutCompatible(ParametrizedMethod compatibleMethod) {
		return compatibleMethod.getParameterTypeIn().contains(new ParametrizedType(SentenceModel.class, List.class, ListSentenceBasedIn.class));
	}
}
