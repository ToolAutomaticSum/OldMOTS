package liasd.asadera.tools.pythonWrapper;
...
public class Word2VecPythonBuilder {
	 ...
	 *
	 * Once the module is imported than we obtain a reference to it and assign the
	...
	public Word2VecPython build() {
		try {
			...
			jep.eval("w2vp = jep.jproxy(pw2vw, ['liasd.asadera.tools.pythonWrapper.Word2VecPython'])");
