...
public class englishStemmer extends SnowballStemmer {
	...
	private boolean r_Step_1b() {
		...
		case 2:
			// (, line 79
			// test.java.liasd.asadera.tools.pythonWrapper, line 80
			v_1 = limit - cursor;
			// gopast, line 80
			golab0: while (true) {
				lab1: do {
			...
			// delete, line 80
			slice_del();
			// test.java.liasd.asadera.tools.pythonWrapper, line 81
			v_3 = limit - cursor;
			// substring, line 81
			...
			case 3:
				...
				// test.java.liasd.asadera.tools.pythonWrapper, line 87
				v_4 = limit - cursor;
				// call shortv, line 87
				if (!r_shortv()) {
					return false;
	...
	private boolean r_postlude() {
		...
		int v_2;
		// (, line 203
		// Boolean test.java.liasd.asadera.tools.pythonWrapper Y_found, line 203
		if (!(B_Y_found)) {
			return false;
		}
		// repeat, line 203
