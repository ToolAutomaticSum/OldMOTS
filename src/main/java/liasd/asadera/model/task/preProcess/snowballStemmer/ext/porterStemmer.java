...
public class porterStemmer extends SnowballStemmer {
	...
	private boolean r_Step_1b() {
		...
		case 2:
			// (, line 37
			// test.java.liasd.asadera.tools.pythonWrapper, line 38
			v_1 = limit - cursor;
			// gopast, line 38
			golab0: while (true) {
				lab1: do {
			...
			// delete, line 38
			slice_del();
			// test.java.liasd.asadera.tools.pythonWrapper, line 39
			v_3 = limit - cursor;
			// substring, line 39
			...
			case 3:
				...
				// test.java.liasd.asadera.tools.pythonWrapper, line 45
				v_4 = limit - cursor;
				// call shortv, line 45
				if (!r_shortv()) {
					return false;
	...
	public boolean stem() {
		...
		lab23: do {
			// (, line 137
			// Boolean test.java.liasd.asadera.tools.pythonWrapper Y_found, line 137
			if (!(B_Y_found)) {
				break lab23;
			}
			// repeat, line 137
