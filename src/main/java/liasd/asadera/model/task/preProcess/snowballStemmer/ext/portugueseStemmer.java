		...
		case 1:
			...
			lab0: do {
				...
				lab1: do {
					...
					// ], line 194
					bra = cursor;
					// test.java.liasd.asadera.tools.pythonWrapper, line 194
					v_2 = limit - cursor;
					// literal, line 194
					if (!(eq_s_b(1, "g"))) {
						break lab1;
				...
				// ], line 195
				bra = cursor;
				// test.java.liasd.asadera.tools.pythonWrapper, line 195
				v_3 = limit - cursor;
				// literal, line 195
				if (!(eq_s_b(1, "c"))) {
					return false;
			...
			lab3: do {
				...
				lab4: do {
					...
					lab7: do {
						...
						// ], line 207
						bra = cursor;
						// test.java.liasd.asadera.tools.pythonWrapper, line 207
						v_8 = limit - cursor;
						// literal, line 207
						if (!(eq_s_b(1, "c"))) {
							break lab7;
