...
public class Inferencer
{
    ...
    public Inferencer(LDACmdOption option, Model trnModel) throws FileNotFoundException, IOException
    {
        this.option = option;
    ...
    public Model inference(boolean saveModel) throws FileNotFoundException, IOException
    {
