 ...
 *
 */
public abstract class CentroidError extends AbstractScoringMethod implements VectorCaracteristicBasedIn, VectorCaracteristicBasedOut {
	...
	public CentroidError(int id) throws Exception {
		super(id);
	}
	...
	protected ClusterCentroid instanciateCluster(String clusterType) throws NullPointerException {
		ClusterCentroid cluster = null;
		if (clusterType.equals("TF_IDF"))
			;//cluster = new ClusterCentroid_TF_IDF(idCluster, dictionnary, nbMaxWordInCluster, thresholdCluster);
		else
