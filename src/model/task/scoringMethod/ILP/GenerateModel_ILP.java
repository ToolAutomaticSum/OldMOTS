...
public class GenerateModel_ILP extends AbstractScoringMethod implements BiGramListBasedIn, FileModelBasedOut {
	...
	public GenerateModel_ILP(int id) {
		super(id);
	}
	...
	public void buildModel()
	{
		...
		{
			System.out.print(i+ " : ");
			this.bigrams.get(i).printNGram(hashMapWord);
			System.out.print("\n");
		}
		System.out.println("############### Poids #############");
		for (int i = 0; i < this.bigram_weights.size(); i ++)
		{
			System.out.println(i+" : "+this.bigram_weights.get(i));
		}
		System.out.println("############### Phrases #############");
		for (int i = 0; i < this.bigrams_in_sentence.size(); i++)
		{
			ArrayList <Integer> curr_arr = this.bigrams_in_sentence.get(i);
			System.out.print (i+" : ");
			for (int j = 0; j < curr_arr.size(); j ++)
			{
				System.out.print(curr_arr.get(j)+" ");
			}
			System.out.println("");
		}*/
